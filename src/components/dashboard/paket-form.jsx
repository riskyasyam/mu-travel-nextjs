...
export default function PaketForm({ paket }) {
  ...
  // --- 1. DEFINISIKAN PILIHAN MASKAPAI DI SINI ---
  const airlines = [
    "Lion Air",
    "Garuda Indonesia",
    "Citilink",
  ...
  return (
    <form action={isEditMode ? updatePaketWithId : createPaket} encType="multipart/form-data" className="space-y-6">
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
        {/* Kolom Kiri */}
        <div className="space-y-4">
            {/* ... (field Nama Paket, Foto, Harga, Durasi, Tanggal, Sisa Kursi tetap sama) ... */}
            <div>
            ...
            <div>
              ...
              <input type="file" name="fotoPaket" id="fotoPaket" className="mt-1 block w-full text-sm text-slate-500 file:mr-4 file:py-2 file:px-4 file:rounded-full file:border-0 file:text-sm file:font-semibold file:bg-blue-50 file:text-blue-700 hover:file:bg-blue-100" required={!isEditMode} />
            ...
            {isEditMode && paket?.fotoUrl && (
              <div>
                ...
                <Image src={paket.fotoUrl} alt={paket.namaPaket} width={200} height={150} className="rounded-md object-cover" />
              </div>
            )}
            <div>
        ...
        <div className="space-y-4">
          ...
          {/* ... (field Hotel Madinah, Rating, Hotel Makkah, Rating tetap sama) ... */}
           <div>
